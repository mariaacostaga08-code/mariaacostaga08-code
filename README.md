...
#### 🤖 ProyectoRAG_Acosta
> **Sistema de Inteligencia Artificial personalizada para la gestión de normativas.**

* **Descripción:** Una solución innovadora que permite realizar consultas precisas sobre normativas de **Ciencias Comerciales** y documentos educativos, garantizando respuestas basadas exclusivamente en fuentes oficiales.
* **Impacto:** Optimiza el tiempo de consulta para docentes y estudiantes de bachillerato.

**Stack Tecnológico:**
![NotebookLM](https://img.shields.io/badge/NotebookLM-4285F4?style=flat-square&logo=google&logoColor=white) 
![Generative AI](https://img.shields.io/badge/IA_Generativa-blueviolet?style=flat-square&logo=openai&logoColor=white)
